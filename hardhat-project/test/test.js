...
describe("MyContracts", function(){
    ...
    it("Checks that the contract name deployed is correct", async function(){
        ...
        let tx = await myContractDeployed.mintCertificate("0x532354D85920702C461C59B33b14911D8D1b97F5", 0, "ipfs://bafkreih6lb4abox5c5ebphblr6cgrrucihpsmfasl7lugjb5yw3jevnaoe");
        console.log("tx:", tx);
        await myContractDeployed.deployed();
        expect(await myContractDeployed.name()).to.equal("CertificateNFT");
        expect(await myContractDeployed.symbol()).to.equal("NFT");
        // expect(await myContractDeployed.updateContractDeployer("0x532354D85920702C461C59B33b14911D8D1b97F5")).to.equal("address updated successfully");
